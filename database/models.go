...
type AuctionCreatedEvent struct {
	...
	AuctionId     string    `json:"auction_id" gorm:"column:auction_id;type:numeric(78,0);index:idx_ace_auction_id;not null"`
	...
	TokenId       string    `json:"token_id" gorm:"column:token_id;type:numeric(78,0)"`
	StartPriceUsd string    `json:"start_price_usd" gorm:"column:start_price_usd;type:numeric(78,0)"`
...
type BidPlacedEvent struct {
	...
	AuctionId    string    `json:"auction_id" gorm:"column:auction_id;type:numeric(78,0);index:idx_bpe_auction_id;not null"`
	...
	BidAmount    string    `json:"bid_amount" gorm:"column:bid_amount;type:numeric(78,0)"`
	BidUsdAmount string    `json:"bid_usd_amount" gorm:"column:bid_usd_amount;type:numeric(78,0)"`
	CreatedAt    time.Time `json:"created_at"`
}
...
type AuctionEndedEvent struct {
	...
	AuctionId    string    `json:"auction_id" gorm:"column:auction_id;type:numeric(78,0);index:idx_aee_auction_id;not null"`
	Buyer        string    `json:"buyer" gorm:"index:idx_aee_buyer;size:42;not null"`
	TokenAddress string    `json:"token_adress" gorm:"index:idx_bpe_token_address;size:42;not null"`
	Price        string    `json:"price" gorm:"column:price;type:numeric(78,0)"`
	UsdPrice     string    `json:"usdPrice" gorm:"column:usd_price;type:numeric(78,0)"`
	CreatedAt    time.Time `json:"created_at"`
}
